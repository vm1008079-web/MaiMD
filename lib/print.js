...
export default async function (m, conn = { user: {} }) {
    ...
    console.log(`${chalk.white(chalk.bgCyanBright('☁︎ Mai Bot ☁︎'))} ${chalk.white(oraColombia)}

✿  Nombre: ${chalk.white('%s')}
⌨  Tamaño: ${chalk.white('%s [%s %sB]')}
✦  Usuario: ${chalk.white('%s')}
✐  ID: ${chalk.white('%s%s')}
❀  Chat: ${chalk.white(chatName)}
⎙  Fecha: ${chalk.white('%s')}
`.trim(),
