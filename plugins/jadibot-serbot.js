...
let drm1 = ""
let drm2 = ""
let rtx = `*☁︎✧ 𝙈𝙖𝙞 𝘽𝙤𝙩 - SubBot QR ✧☁︎*\n\n` +
`✐ Conexión rápida en *Modo QR* para convertirte en un ✦ *Sub-Bot Temporal* ✦\n\n` +
`❀ Usa otro celular o tu PC y sigue estos pasos:\n\n` +
`\`1\` » Toca los tres puntitos arriba a la derecha\n` +
`\`2\` » Entra en *Dispositivos vinculados*\n` +
`\`3\` » Escanea el código QR que aparece ahora\n\n` +
`✧ Este código QR expira en *45 segundos*, no te duermas ☁︎`
let rtx2 = `*☁︎✧ 𝙈𝙖𝙞 𝘽𝙤𝙩 - SubBot Código ✧☁︎*\n\n` +
`✐ Conexión en *Modo Código* para volverte un ✦ *Sub-Bot Temporal* ✦\n\n` +
`❀ Sigue estos pasos desde otro dispositivo:\n\n` +
`\`1\` » Toca los tres puntitos arriba a la derecha\n` +
`\`2\` » Entra en *Dispositivos vinculados*\n` +
`\`3\` » Selecciona *Vincular con número de teléfono*\n` +
`\`4\` » Escribe el código que te proporcionamos\n\n` +
`✧ No uses tu cuenta principal por seguridad ☁︎`
